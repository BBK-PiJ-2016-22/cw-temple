...
public interface Constants {
  double GAME_WIDTH_PROP = 0.78;       //Width of the main.java.game portion (prop of total)
  double GAME_HEIGHT_PROP = 1.0;      //Height of the main.java.game portion (prop of total)
